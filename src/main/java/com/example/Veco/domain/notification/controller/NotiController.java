...
public class NotiController {
    ...
    @Operation(
            ...
            description = "마감기한이 오늘까지인 알림 목록을 조회합니다. Path Parameter로 알림타입 (ISSUE,GOAL,EXTERNAL) 주시면 됩니다." +
    ...
    public ApiResponse<?> getAlarmList(
        ...
        return ApiResponse.onSuccess(notiQueryService.getNotiList(memberId,alarmtype));
    }
