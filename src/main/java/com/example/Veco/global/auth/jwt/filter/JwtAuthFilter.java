...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private static final String[] excludePaths = {"/", "/api/test/login/", "/api/token/reissue", "/login-test.html", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-resources/**", "/css/**", "/images/**", "/js/**", "/h2-console/**", "/profile", "/github/**"};
